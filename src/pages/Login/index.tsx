...
export default function Login() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await loadingWithDelay(() =>
        authApi.login({
          email: email.trim(),
          senha,
        }),
      ...
      setErrorMessage(
        apiError.mensagem ?? "N&atilde;o foi poss&iacute;vel entrar agora.",
      );
    } finally {
  ...
  return (
    <>
      <LoadingOverlay isVisible={isLoading} message="Conectando..." />
      <AuthLayout
